...
class TextTranslations {
  ...
  String get globalStats =>
      Intl.message('', name: 'globalStats');
  String get contaminated =>
      Intl.message('', name: 'contaminated');
  String get deaths =>
      Intl.message('', name: 'deaths');
  String get recovered =>
      Intl.message('', name: 'recovered');
  String get about =>
      Intl.message('', name: 'about');
  String get selectCountryDefaultText =>
      Intl.message('', name: 'selectCountryDefaultText');
  String get faqQuestion1 =>
      Intl.message('', name: 'FAQQuestion1');
  String get faqQuestion2 =>
      Intl.message('', name: 'FAQQuestion2');
  String get faqQuestion3 =>
      Intl.message('', name: 'FAQQuestion3');
  String get faqQuestion4 =>
      Intl.message('', name: 'FAQQuestion4');
  String get faqQuestion5 =>
      Intl.message('', name: 'FAQQuestion5');
  String get faqQuestion6 =>
      Intl.message('', name: 'FAQQuestion6');
  String get faqQuestion7 =>
      Intl.message('', name: 'FAQQuestion7');
  String get faqQuestion9 =>
      Intl.message('', name: 'FAQQuestion9');
  String get faqQuestion10 =>
      Intl.message('', name: 'FAQQuestion10');
  String get faqAnswer1 =>
      Intl.message('', name: 'FAQAnswer1');
  String get faqAnswer2 =>
      Intl.message('', name: 'FAQAnswer2');
  String get faqAnswer3 =>
      Intl.message('', name: 'FAQAnswer3');
  String get faqAnswer4 =>
      Intl.message('', name: 'FAQAnswer4');
  String get faqAnswer5 =>
      Intl.message('', name: 'FAQAnswer5');
  String get faqAnswer6 =>
      Intl.message('', name: 'FAQAnswer6');
  String get faqAnswer7 =>
      Intl.message('', name: 'FAQAnswer7');
  String get faqAnswer8 =>
      Intl.message('', name: 'FAQAnswer8');
  String get faqAnswer9 =>
      Intl.message('', name: 'FAQAnswer9');
  String get appDesc1 =>
      Intl.message('', name: 'appDesc1');
  String get appDesc2 =>
      Intl.message('', name: 'appDesc2');
  String get appDesc3 =>
      Intl.message('', name: 'appDesc3');
  String get appDesc4 =>
      Intl.message('', name: 'appDesc4');
  String get appDesc5 =>
      Intl.message('', name: 'appDesc5');
}
